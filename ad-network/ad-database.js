...
export const adsDb = [
  ...
  generateAd(addresses.transportAdvertiser, 'trains_lover', '/static/images/pkp.png', 'https://pkp.pl', 0.5),
  generateAd(addresses.transportAdvertiser, 'planes_lover', '/static/images/lot.svg', 'https://lot.com', 0.6),
